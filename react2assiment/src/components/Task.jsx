    ...
    >
      {(provided, snapshot) => (
        ...
        >
          ...
          <Dates>
            <div>Created: {new Date(task.creationDate).toLocaleDateString()}</div>
            {task.completionDate && (
              <div>Completed: {new Date(task.completionDate).toLocaleDateString()}</div>
            )}
          </Dates>
          {!isCompleted && (
            <Icons>
              ...
              <IconButton onClick={() => onDelete(task.id)} aria-label="Delete task">
                <FaTrash />
              </IconButton>
            </Icons>
          )}
